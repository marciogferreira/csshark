...
class PedidosRelatorios extends RelatoriosServices {
    ...
    public function config($params) {
        ...
        $itensPedidos = NegociosServices::getItensByOrderIdOrderProduct($params['pedidos']);
